...
const handleTool = async (
  ...
  try {
    const config = params.config || queryConfig;
...
function createServer({ config }: { config?: Record<string, any> }) {
  ...
  server.tool(
    ...
    async (params) => {
      return handleTool(config, params, async (gmail: gmail_v1.Gmail) => {
        let raw = params.raw;
  ...
  server.tool("get_imap", "Gets IMAP settings", {}, async (params) => {
    return handleTool(config, params, async (gmail: gmail_v1.Gmail) => {
  ...
  server.tool("get_language", "Gets language settings", {}, async (params) => {
    return handleTool(config, params, async (gmail: gmail_v1.Gmail) => {
  ...
  server.tool("get_pop", "Gets POP settings", {}, async (params) => {
    return handleTool(config, params, async (gmail: gmail_v1.Gmail) => {
